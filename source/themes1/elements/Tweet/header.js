enyo.kind({
	...
	components: [
		...
		{name: "extra", layoutKind: "FittableColumnsLayout", style: "float: right;", components: [
			// indicators
			// unread
				{name: "unread", kind: "Neo.Icon", icon: "flash", _res: 'ldpi/',
					classes: "", style:'height: 13px;', showing: false},
			// favorite
				{name: "favorite", kind: "Neo.Icon", icon: "heart", _res: 'ldpi/',
					classes: "", style:'height: 13px;', showing: false},
			// private
				{name: "private", kind: "Neo.Icon", icon: "lock_closed", _res: 'ldpi/',
					classes: "", style:'height: 13px;', showing: false},
